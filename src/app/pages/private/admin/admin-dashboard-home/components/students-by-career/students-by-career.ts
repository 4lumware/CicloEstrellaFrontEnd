...
@Component({
  selector: 'app-students-by-career',
  standalone: true,
  imports: [BaseChartDirective, MatCardModule, MatProgressSpinnerModule],
  templateUrl: './students-by-career.html',
  styleUrl: './students-by-career.css',
})
export class StudentsByCareer implements OnInit {
  ...
  private load(): void {
    ...
    this.srv.studentsByCareer().subscribe({
